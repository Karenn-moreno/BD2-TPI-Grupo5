...
---VenderEntrada: inserta una entrada si el asiento está disponible.
...
BEGIN
    ...
    BEGIN
        RAISERROR('La venta indicada no existe o está anulada.', 16, 1);
        RETURN;
    END;
    ...
    BEGIN
        RAISERROR('La función indicada no existe.', 16, 1);
        RETURN;
    END;
    ...
    BEGIN
        RAISERROR('El asiento ya se encuentra vendido para esta función.', 16, 1);
        RETURN;
    END;
